...
@export var spawn_decrease_day_by_day = 0.3;
...
# time before this spawner can be used again.  i believe?
...
func _ready():
	spawn_interval -= spawn_decrease_day_by_day * RunData.days_survived;
